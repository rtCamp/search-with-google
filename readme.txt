...
If you still need to [log an issue](https://github.com/rtCamp/google-custom-search/issues/new), making sure to include as much detail as you can, including clear steps to reproduce the issue, if possible.
